...
type Notification struct {
	...
	SourceID   uint64     `gorm:"not null;" json:"sourceID"`
	SourceType string     `gorm:"type:varchar(255) ; null;" validate:"required"  json:"sourceType"`
	Type       int        `gorm:"smallint:6;DEFAULT:'0'" json:"type"`
	Read       int        `gorm:"smallint:1;DEFAULT:'1'" json:"read"`
	Trash      int        `gorm:"smallint:1;DEFAULT:'1'" json:"trash"`
