...
type UserAppInterface struct {
	SaveUserFn                  func(*entity.Users) (*entity.Users, map[string]string)
	GetUsersFn                  func() ([]entity.Users, error)
	GetUserFn                   func(uint64) (*entity.Users, error)
	GetUserByEmailAndPasswordFn func(*entity.Users) (*entity.Users, map[string]string)
}

//SaveUser calls the SaveUserFn
func (u *UserAppInterface) SaveUser(user *entity.Users) (*entity.Users, map[string]string) {
	return u.SaveUserFn(user)
}

//GetUsersFn calls the GetUsers
func (u *UserAppInterface) GetUsers() ([]entity.Users, error) {
	return u.GetUsersFn()
}

//GetUserFn calls the GetUser
func (u *UserAppInterface) GetUser(userId uint64) (*entity.Users, error) {
	return u.GetUserFn(userId)
}

//GetUserByEmailAndPasswordFn calls the GetUserByEmailAndPassword
func (u *UserAppInterface) GetUserByEmailAndPassword(user *entity.Users) (*entity.Users, map[string]string) {
...
type PostAppInterface struct {
	...
	GetAllPaginationostFn func() ([]entity.Post, error)
...
func (f *PostAppInterface) GetAllPaginationost() ([]entity.Post, error) {
	return f.GetAllPaginationostFn()
}
